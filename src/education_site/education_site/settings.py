"""
Django settings for education_site project.
...
SECRET_KEY = 'django-insecure-m((tv(j5g!b6yvd$-&!1h4xh0@z8x%=o4$e@a6%+-jsluw6lq('
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.views.role_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'education_site.wsgi.application'
